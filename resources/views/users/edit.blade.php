                ...
                <form action="{{ route('users.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" placeholder="Username" id="grid-last-name" value="{{ $item->name}}"
                                name="name"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" placeholder="Email" id="grid-last-name" value="{{ $item->email}}" readonly
                                name="email"
                                class="appearance-none black w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:botder-gray-500">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" placeholder="Address" id="grid-last-name" value="{{  $item->address }}"
                                name="address"
                                class="appearance-none black w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:botder-gray-500">
                        </div>
                    </div>
                    <div class="flex flex-row">
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input type="text" placeholder="House Number" id="grid-last-name"
                                    value="{{  $item->houseNumber }}" name="houseNumber"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 mr-4">
                            <div class="w-full px-3">
                                ...
                                <input type="text" placeholder="City" id="grid-last-name" value="{{ $item->city }}"
                                    name="city"
                                    class="appearance-none black w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:botder-gray-500">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input type="number" placeholder="Phone Number" id="grid-last-name"
                                    value="{{  $item->phoneNumber }}" name="phoneNumber"
