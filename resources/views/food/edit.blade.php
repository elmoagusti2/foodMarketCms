    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{ route('foods.update', $item->id) }}" class="w-full" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" placeholder="Name Products" id="grid-last-name"
                    ...
                    <div class="flex flex-row">
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-48 px-3">
                                ...
                                <select name="types"
                                    class="appearance-none black  w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:botder-gray-500">
                                    <option value="MAKANAN" {{ $item->types == 'MAKANAN' ? 'selected' : '' }}>Makanan
                                    </option>
                                    <option value="MINUMAN"{{ $item->types == 'MINUMAN' ? 'selected' : '' }}>Minuman
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <textarea placeholder="Description" id="grid-last-name" name="description"
                                class="appearance-none black w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:botder-gray-500"> {{ $item->description }} </textarea>
                        </div>
                    </div>
                    <div class="flex flex-row">
                        <div class="flex flex-wrap -mx-3 mb-6">
